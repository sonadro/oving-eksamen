...
const PORT = 80;
const DB_URI = `mongodb+srv://${dbUser}:${dbPass}@cluster0.vnz2jh4.mongodb.net/wishlistDatabase`;
...
// 404
server.use((req, res) => res.status(404).render('404', { title: 'Page not found', navText: '' }));